...
class BaseAdminApi {
  static supabase = createClient(
    ...
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpwaGJ3bGxmdmhwd2l4enBqeG5kIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMDExNzY3MywiZXhwIjoyMDQ1NjkzNjczfQ.tXMwcs8Pc9Xu6QfHJlN-s5OVA5jX-nr5UJDxVS55ARg"
  );
}

export default BaseAdminApi;
